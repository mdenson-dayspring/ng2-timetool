...
import { WeekTableRowComponent } from '../week/weektablerow.component';

@Component({
    template: require('app/week/weektable.component.html'),
    styles: [require('app/week/weektable.component.css')],
    selector: 'weektable',
    directives: [WeekTableRowComponent]
})
